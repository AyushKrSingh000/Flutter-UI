...
// // This page is same as profile_page but there are some_changes in bottom navigation bar .If I use bottomnavigation bar of scaffold then there is pixel flow error to show the image behind the bottom bar.
// //Uncomment this to check the changes
